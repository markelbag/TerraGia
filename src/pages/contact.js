...
const Contact = () => (
  <Layout>
    ...
    <h1>This is where the contact information and form will go</h1>
    {/* <MyGatsbyComponents /> */}
    <Example />
  </Layout>
)
    ...
    <div className="bg-white">
      <Popover as="header" className="relative z-10">
        <div className="bg-gray-50">
          <nav
            className="relative flex items-center justify-between px-6 pt-8 mx-auto max-w-7xl xl:px-8"
            aria-label="Global"
          >
        ...
        <div className="bg-purple-400">
          <div className="max-w-md px-4 py-16 mx-auto text-center sm:max-w-2xl sm:py-24 sm:px-6 lg:px-8 lg:py-32">
            ...
            >
              ...
              <ExternalLinkIcon
                className="flex-shrink-0 w-5 h-5 ml-3 text-gray-400"
                aria-hidden="true"
              />
            </a>
          </div>
      ...
      <footer className="bg-gray-900" aria-labelledby="footer-heading">
        ...
        <div className="max-w-md px-4 py-12 mx-auto sm:max-w-lg sm:pt-16 sm:px-6 lg:max-w-7xl lg:pt-24 lg:pb-16 lg:px-8">
